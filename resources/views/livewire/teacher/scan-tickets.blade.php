        ...
        return new Promise((resolve, reject) => {
            ...
            try {
                ...
                html5QrCode.start({
                    ...
                    (decodedText) => {
                        ...
                        stopScanner().then(() => {
                            if (typeof window.Livewire !== 'undefined') {
                                window.Livewire.dispatch('scan-detected', {
                                    code: decodedText
                                });
                            } else {
                    ...
                    scannerActive = true;
                    if (statusElement) statusElement.textContent = 'Camera is active.';
                    if (resultContainer) resultContainer.innerHTML = '<div>Scanner ready. Point camera at a ticket QR code.</div>';
                    resolve();
                }).catch((err) => {
